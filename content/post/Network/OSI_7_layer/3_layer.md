...
[네트워크 전반적인 과정에 대해 문의드립니다.](https://www.inflearn.com/questions/661260/%EB%84%A4%ED%8A%B8%EC%9B%8C%ED%81%AC-%EC%A0%84%EB%B0%98%EC%A0%81%EC%9D%B8-%EA%B3%BC%EC%A0%95%EC%97%90-%EB%8C%80%ED%95%B4-%EB%AC%B8%EC%9D%98%EB%93%9C%EB%A6%BD%EB%8B%88%EB%8B%A4) 이 인프런 질문 글을 보면 이 내용에 대해 답변을 해놨으니 반드시 매번 확인하자. 

위 답변에 따르자면 한 라우터에 다른 라우터로 이동할 때 라우터마다 내부적으로 물리 계층 - 데이터 링크 계층 - 네트워크 계층 까지의 캡슐화와 역캡슐화가 계속 이뤄진다고 이해하면 된다. 
