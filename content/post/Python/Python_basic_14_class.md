...
> **_namespace란 python의 해당 객체와 관련된 attribute의 name들이 저장된 공간_** 으로서, dictionary가 python의 naming system에 사용하기 때문에, 각 name은 key로서 중복되지 않는다.
...
**_namespace에는 객체의 속성들이 있는 곳임을 확인했다._** 그러면 class와 instance의 각 속성들을 한층 더 들어가 확인해보자.
