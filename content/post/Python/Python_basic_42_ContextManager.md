...
- Context manager의 대표적인 구문인 with를 이해해야한다.
  - with문에 관한 내용은 [[TIL] Python basic 20: with open as](https://jeha00.github.io/post/python/python_basic_20_filewriteread_1/) 와 [[TIL] Python basic 21: csv.read, write](https://jeha00.github.io/post/python/python_basic_21_filereadwrite_2/)을 참고한다.
